...
public class UserControlSetStateToSourceAction : TriggerAction<UserControl>
{
    ...
    {
        get => (UserControlUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(UserControlUnbindableCanReadProperty), typeof(UserControlSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(UserControlSetStateToSourceAction), new PropertyMetadata(null));
