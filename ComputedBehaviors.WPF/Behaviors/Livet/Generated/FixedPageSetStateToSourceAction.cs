...
public class FixedPageSetStateToSourceAction : TriggerAction<FixedPage>
{
    ...
    {
        get => (FixedPageUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(FixedPageUnbindableCanReadProperty), typeof(FixedPageSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(FixedPageSetStateToSourceAction), new PropertyMetadata(null));
