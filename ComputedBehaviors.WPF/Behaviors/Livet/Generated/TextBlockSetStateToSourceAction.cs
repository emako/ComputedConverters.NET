...
public class TextBlockSetStateToSourceAction : TriggerAction<TextBlock>
{
    ...
    {
        get => (TextBlockUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(TextBlockUnbindableCanReadProperty), typeof(TextBlockSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(TextBlockSetStateToSourceAction), new PropertyMetadata(null));
