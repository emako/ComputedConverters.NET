...
public class FrameworkElementSetStateToSourceAction : TriggerAction<FrameworkElement>
{
    ...
    {
        get => (FrameworkElementUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(FrameworkElementUnbindableCanReadProperty), typeof(FrameworkElementSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(FrameworkElementSetStateToSourceAction), new PropertyMetadata(null));
