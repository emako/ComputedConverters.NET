...
public class ToolBarSetStateToSourceAction : TriggerAction<ToolBar>
{
    ...
    {
        get => (ToolBarUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(ToolBarUnbindableCanReadProperty), typeof(ToolBarSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(ToolBarSetStateToSourceAction), new PropertyMetadata(null));
    ...
    protected override void Invoke(object parameter)
    {
        switch (Property)
        {
            case ToolBarUnbindableCanReadProperty.HasOverflowItems:
                if ((bool)Source != AssociatedObject.HasOverflowItems)
                {
