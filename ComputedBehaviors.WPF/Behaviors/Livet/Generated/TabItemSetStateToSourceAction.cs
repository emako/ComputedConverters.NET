...
public class TabItemSetStateToSourceAction : TriggerAction<TabItem>
{
    ...
    {
        get => (TabItemUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(TabItemUnbindableCanReadProperty), typeof(TabItemSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(TabItemSetStateToSourceAction), new PropertyMetadata(null));
