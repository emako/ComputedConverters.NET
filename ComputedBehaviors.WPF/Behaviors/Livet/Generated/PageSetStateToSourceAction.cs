...
public class PageSetStateToSourceAction : TriggerAction<Page>
{
    ...
    {
        get => (PageUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(PageUnbindableCanReadProperty), typeof(PageSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(PageSetStateToSourceAction), new PropertyMetadata(null));
    ...
    protected override void Invoke(object parameter)
    {
        switch (Property)
        {
            case PageUnbindableCanReadProperty.WindowTitle:
                if ((string)Source != AssociatedObject.WindowTitle)
                {
            ...
            case PageUnbindableCanReadProperty.WindowHeight:
                if ((double)Source != AssociatedObject.WindowHeight)
                {
            ...
            case PageUnbindableCanReadProperty.WindowWidth:
                if ((double)Source != AssociatedObject.WindowWidth)
                {
            ...
            case PageUnbindableCanReadProperty.ShowsNavigationUI:
                if ((bool)Source != AssociatedObject.ShowsNavigationUI)
                {
