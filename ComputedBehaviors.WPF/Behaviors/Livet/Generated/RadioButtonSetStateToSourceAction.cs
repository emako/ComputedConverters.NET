...
public class RadioButtonSetStateToSourceAction : TriggerAction<RadioButton>
{
    ...
    {
        get => (RadioButtonUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(RadioButtonUnbindableCanReadProperty), typeof(RadioButtonSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(RadioButtonSetStateToSourceAction), new PropertyMetadata(null));
