...
public class ThumbSetStateToSourceAction : TriggerAction<Thumb>
{
    ...
    {
        get => (ThumbUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(ThumbUnbindableCanReadProperty), typeof(ThumbSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(ThumbSetStateToSourceAction), new PropertyMetadata(null));
