...
public class ProgressBarSetStateToSourceAction : TriggerAction<ProgressBar>
{
    ...
    {
        get => (ProgressBarUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(ProgressBarUnbindableCanReadProperty), typeof(ProgressBarSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(ProgressBarSetStateToSourceAction), new PropertyMetadata(null));
