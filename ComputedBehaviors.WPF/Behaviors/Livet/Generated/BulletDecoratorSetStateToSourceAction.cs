...
public class BulletDecoratorSetStateToSourceAction : TriggerAction<BulletDecorator>
{
    ...
    {
        get => (BulletDecoratorUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(BulletDecoratorUnbindableCanReadProperty), typeof(BulletDecoratorSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(BulletDecoratorSetStateToSourceAction), new PropertyMetadata(null));
