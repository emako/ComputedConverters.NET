...
public class GridSplitterSetStateToSourceAction : TriggerAction<GridSplitter>
{
    ...
    {
        get => (GridSplitterUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(GridSplitterUnbindableCanReadProperty), typeof(GridSplitterSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(GridSplitterSetStateToSourceAction), new PropertyMetadata(null));
    ...
    protected override void Invoke(object parameter)
    {
        switch (Property)
        {
            case GridSplitterUnbindableCanReadProperty.IsDragging:
                if ((bool)Source != AssociatedObject.IsDragging)
                {
