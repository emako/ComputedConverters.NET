...
public class CalendarButtonSetStateToSourceAction : TriggerAction<CalendarButton>
{
    ...
    {
        get => (CalendarButtonUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(CalendarButtonUnbindableCanReadProperty), typeof(CalendarButtonSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(CalendarButtonSetStateToSourceAction), new PropertyMetadata(null));
    ...
    protected override void Invoke(object parameter)
    {
        switch (Property)
        {
            case CalendarButtonUnbindableCanReadProperty.HasSelectedDays:
                if ((bool)Source != AssociatedObject.HasSelectedDays)
                {
