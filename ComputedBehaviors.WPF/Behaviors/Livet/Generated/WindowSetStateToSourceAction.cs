...
public class WindowSetStateToSourceAction : TriggerAction<Window>
{
    ...
    {
        get => (WindowUnbindableCanReadProperty)GetValue(PropertyProperty);
        set => SetValue(PropertyProperty, value);
    }

    public static readonly DependencyProperty PropertyProperty =
        DependencyProperty.Register(nameof(Property), typeof(WindowUnbindableCanReadProperty), typeof(WindowSetStateToSourceAction), new PropertyMetadata());
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(object), typeof(WindowSetStateToSourceAction), new PropertyMetadata(null));
