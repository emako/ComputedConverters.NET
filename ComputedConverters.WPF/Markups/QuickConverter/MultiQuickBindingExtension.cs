...
public class MultiQuickBindingExtension : MarkupExtension
{
    ...
    /// </summary>
    public object TargetNullValue { get; set; } = null!;
    ...
    /// </summary>
    public IMultiValueConverter ExternalConverter { get; set; } = default!;
        ...
        try
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    getExpression = !propType.IsAssignableFrom(typeof(MultiBinding));
                }
            }

            var holder = new MultiBinding() { Mode = Mode, UpdateSourceTrigger = UpdateSourceTrigger };
