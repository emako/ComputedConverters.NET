...
internal class SingleLineLambdaVisitor : ExpressionVisitor
{
    ...
    private readonly List<ConditionalNode> _conditionalReferences = [];
    ...
    private DependencyNode? GetOrCreateNode<T>(T node, Func<T, DependencyNode?> creator) where T : Expression
    {
